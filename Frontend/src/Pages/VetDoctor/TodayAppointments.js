...
{/* up three buttons-prev,today,upcoming */}
        ...
        verticalAlign:'center',position:"fixed",top:'20%',left:'25%'}}>
            ...
            <Stack><Button variant="outlined" 
            style={{display:'inline-block',width: '250px',margin:10,marginLeft:90, fontSize:'15px'
           
            }}>Previous jobs </Button></Stack> 

            <Stack><Button variant="contained" style={{display:'inline-block',width: '250px',margin:10, 
            backgroundColor:'#68FD22',fontSize:'15px'
...
{/* list of appointment box  */}
        <div style={{ flexDirection:'row',display:'inline-flex',height:55,margin:10,width:window.width,
            verticalAlign:'center',position:"fixed",top:'45%',left:'25%',
            flexWrap: 'wrap',
            padding: '10px 20px',
            borderRadius: '27px',
