...
export default function FoodTable() {
  ...
  const deleteOneFood = (foodId) => {
    ...
    Axios.delete(`http://localhost:3001/api/shop/deleteOneFood/${foodId}`).then(
      (response) => {
    ...
    <div>
      ...
      <Stack spacing={10} direction="row" justifyContent="center">
        <ThemeProvider theme={theme}>
          <Button variant="contained" color="blueButton" href="/FoodTableFinal">
            Food
          </Button>
        </ThemeProvider>
        <ThemeProvider theme={theme}>
                    ...
                    <StyledTableCell align="left">
                      ...
                      <ThemeProvider theme={theme}>
                        ...
                        <Button
                          variant="contained"
                          color="delete"
                          onClick={() => deleteOneFood(val.foodId)}
                        >
                          Delete
                        </Button>
                      </ThemeProvider>
