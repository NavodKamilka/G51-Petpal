...
export default function PreviousAppo() {

  const[previousappoList, setPreviousappoList]=useState([]);

  // const ref = useRef(null);
  
  // here we don't have to click any button to display data
  useEffect(() =>{
    Axios.get("http://localhost:3001/api/Doctor/getpreviousappo").then((response)=>{
    setPreviousappoList(response.data.data);   
